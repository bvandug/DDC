...
from ip_simulink_env import SimulinkEnv, DiscretizedActionWrapper  # your classes
...
MODEL_ROOT     = os.path.join("ip_jax", "jax_models") # folder containing run subdirs
...
def main():
    ...
    # run_episode_with_obs(td3, td3_env, "td3_ip_trace.csv", INIT_ANGLE_RAD)
    # td3_env.close()
    ...
    run_episode_with_obs(dqn, dqn_env, "dqn_ip_trace.csv", INIT_ANGLE_RAD)
    dqn_env.close()
