...
with open('dqn_.json', 'r') as f:
    dqn_data = json.load(f)

with open('td3_.json', 'r') as f:
...
# Add enhancements
# plt.title('Inverted Pendulum DQN vs. TD3 Training Convergence')
...
# Save the plot
plt.savefig('IP_dqn_vs_td3_performance.pdf', bbox_inches='tight')
