...
from PYBCEnv import  BuckConverterEnv   # NumPy env
from BCSimulinkEnv import BCSimulinkEnv        # Simulink env
...
def main():
    ...
    ap.add_argument("--model-name", type=str, default="bcSim", help="Simulink model name")
    ...
    # Instantiate envs
    env_np =  BuckConverterEnv(
        dt=args.dt,
        frame_skip=args.frame_skip,
        max_episode_steps=args.max_steps,
        grace_period_steps=args.grace_steps,
        fixed_goal_voltage=args.target,
