###########################################################################
## Makefile generated for component 'pendulum'. 
## 
## Makefile     : pendulum.mk
## Generated on : Fri Oct 03 15:40:33 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\pendulum.exe
...
PRODUCT_NAME              = pendulum
MAKEFILE                  = pendulum.mk
MATLAB_ROOT               = C:\PROGRA~1\MATLAB\R2024b
MATLAB_BIN                = C:\PROGRA~1\MATLAB\R2024b\bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)\win64
START_DIR                 = C:\Users\benva\OneDrive\Documents\MATLAB\SB3_tests\ip_verify_envs\Pendulum0_grt_rtw
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = ISO_C
...
COMPILER_COMMAND_FILE     = pendulum_comp.rsp
CMD_FILE                  = pendulum.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
NODEBUG                   = 1
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\pendulum.exe
...
DEFINES_STANDARD = -DMODEL=pendulum -DNUMST=2 -DNCSTATES=2 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(MATLAB_ROOT)\rtw\c\src\rt_logging.c $(START_DIR)\pendulum_grt_rtw\pendulum.c $(START_DIR)\pendulum_grt_rtw\pendulum_data.c $(START_DIR)\pendulum_grt_rtw\rt_nonfinite.c
...
OBJS = rt_logging.obj pendulum.obj pendulum_data.obj rt_nonfinite.obj
...
{$(START_DIR)\pendulum_grt_rtw}.c.obj:
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\pendulum_grt_rtw}.cpp.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\pendulum_grt_rtw}.cc.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\pendulum_grt_rtw}.cxx.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
pendulum.obj : "$(START_DIR)\pendulum_grt_rtw\pendulum.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\pendulum_grt_rtw\pendulum.c"


pendulum_data.obj : "$(START_DIR)\pendulum_grt_rtw\pendulum_data.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\pendulum_grt_rtw\pendulum_data.c"


rt_nonfinite.obj : "$(START_DIR)\pendulum_grt_rtw\rt_nonfinite.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\pendulum_grt_rtw\rt_nonfinite.c"
