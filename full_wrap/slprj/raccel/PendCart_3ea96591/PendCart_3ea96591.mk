###########################################################################
## Makefile generated for component 'PendCart_3ea96591'. 
## 
## Makefile     : PendCart_3ea96591.mk
## Generated on : Sun Jun 22 13:54:19 2025
## Final product: ./PendCart_3ea96591.exe
...
PRODUCT_NAME              = PendCart_3ea96591
MAKEFILE                  = PendCart_3ea96591.mk
...
COMPILER_COMMAND_FILE     = PendCart_3ea96591_comp.rsp
CMD_FILE                  = PendCart_3ea96591.rsp
...
DEFINES_STANDARD = -DMODEL=PendCart_3ea96591 -DNUMST=2 -DNCSTATES=2 -DHAVESTDIO
...
SRCS = $(START_DIR)/slprj/raccel/PendCart_3ea96591/PendCart_3ea96591.c $(START_DIR)/slprj/raccel/PendCart_3ea96591/PendCart_3ea96591_capi.c $(START_DIR)/slprj/raccel/PendCart_3ea96591/PendCart_3ea96591_data.c $(START_DIR)/slprj/raccel/PendCart_3ea96591/PendCart_3ea96591_tgtconn.c $(START_DIR)/slprj/raccel/PendCart_3ea96591/rt_nonfinite.c $(MATLAB_ROOT)/rtw/c/raccel/raccel_main.c $(MATLAB_ROOT)/rtw/c/raccel/raccel_sup.c $(MATLAB_ROOT)/rtw/c/raccel/raccel_mat.c $(MATLAB_ROOT)/simulink/include/simulink_solver_api.c $(MATLAB_ROOT)/rtw/c/src/rapid/raccel_utils.c $(MATLAB_ROOT)/rtw/c/src/rapid/slsa_sim_common_utils.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/ext_svr.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/updown.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/ext_work.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/rtiostream_interface.c $(MATLAB_ROOT)/toolbox/coder/rtiostream/src/rtiostreamtcpip/rtiostream_tcpip.c $(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils/rtiostream_utils.c
...
OBJS = PendCart_3ea96591.obj PendCart_3ea96591_capi.obj PendCart_3ea96591_data.obj PendCart_3ea96591_tgtconn.obj rt_nonfinite.obj raccel_main.obj raccel_sup.obj raccel_mat.obj simulink_solver_api.obj raccel_utils.obj slsa_sim_common_utils.obj ext_svr.obj updown.obj ext_work.obj rtiostream_interface.obj rtiostream_tcpip.obj rtiostream_utils.obj
...
%.obj : $(START_DIR)/slprj/raccel/PendCart_3ea96591/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/PendCart_3ea96591/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/PendCart_3ea96591/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/PendCart_3ea96591/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/PendCart_3ea96591/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
PendCart_3ea96591.obj : $(START_DIR)/slprj/raccel/PendCart_3ea96591/PendCart_3ea96591.c
	$(CC) $(CFLAGS) -o "$@" "$<"


PendCart_3ea96591_capi.obj : $(START_DIR)/slprj/raccel/PendCart_3ea96591/PendCart_3ea96591_capi.c
	$(CC) $(CFLAGS) -o "$@" "$<"


PendCart_3ea96591_data.obj : $(START_DIR)/slprj/raccel/PendCart_3ea96591/PendCart_3ea96591_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


PendCart_3ea96591_tgtconn.obj : $(START_DIR)/slprj/raccel/PendCart_3ea96591/PendCart_3ea96591_tgtconn.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.obj : $(START_DIR)/slprj/raccel/PendCart_3ea96591/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
