###########################################################################
## Makefile generated for component 'PendCart_249987d3'. 
## 
## Makefile     : PendCart_249987d3.mk
## Generated on : Sun Jun 22 14:32:20 2025
## Final product: ./PendCart_249987d3.exe
...
PRODUCT_NAME              = PendCart_249987d3
MAKEFILE                  = PendCart_249987d3.mk
...
COMPILER_COMMAND_FILE     = PendCart_249987d3_comp.rsp
CMD_FILE                  = PendCart_249987d3.rsp
...
DEFINES_STANDARD = -DMODEL=PendCart_249987d3 -DNUMST=2 -DNCSTATES=2 -DHAVESTDIO
...
SRCS = $(START_DIR)/slprj/raccel/PendCart_249987d3/PendCart_249987d3.c $(START_DIR)/slprj/raccel/PendCart_249987d3/PendCart_249987d3_capi.c $(START_DIR)/slprj/raccel/PendCart_249987d3/PendCart_249987d3_data.c $(START_DIR)/slprj/raccel/PendCart_249987d3/PendCart_249987d3_tgtconn.c $(START_DIR)/slprj/raccel/PendCart_249987d3/rt_nonfinite.c $(MATLAB_ROOT)/rtw/c/raccel/raccel_main.c $(MATLAB_ROOT)/rtw/c/raccel/raccel_sup.c $(MATLAB_ROOT)/rtw/c/raccel/raccel_mat.c $(MATLAB_ROOT)/simulink/include/simulink_solver_api.c $(MATLAB_ROOT)/rtw/c/src/rapid/raccel_utils.c $(MATLAB_ROOT)/rtw/c/src/rapid/slsa_sim_common_utils.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/ext_svr.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/updown.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/ext_work.c $(MATLAB_ROOT)/rtw/c/src/ext_mode/common/rtiostream_interface.c $(MATLAB_ROOT)/toolbox/coder/rtiostream/src/rtiostreamtcpip/rtiostream_tcpip.c $(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils/rtiostream_utils.c
...
OBJS = PendCart_249987d3.obj PendCart_249987d3_capi.obj PendCart_249987d3_data.obj PendCart_249987d3_tgtconn.obj rt_nonfinite.obj raccel_main.obj raccel_sup.obj raccel_mat.obj simulink_solver_api.obj raccel_utils.obj slsa_sim_common_utils.obj ext_svr.obj updown.obj ext_work.obj rtiostream_interface.obj rtiostream_tcpip.obj rtiostream_utils.obj
...
%.obj : $(START_DIR)/slprj/raccel/PendCart_249987d3/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/PendCart_249987d3/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/PendCart_249987d3/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/PendCart_249987d3/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/slprj/raccel/PendCart_249987d3/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
PendCart_249987d3.obj : $(START_DIR)/slprj/raccel/PendCart_249987d3/PendCart_249987d3.c
	$(CC) $(CFLAGS) -o "$@" "$<"


PendCart_249987d3_capi.obj : $(START_DIR)/slprj/raccel/PendCart_249987d3/PendCart_249987d3_capi.c
	$(CC) $(CFLAGS) -o "$@" "$<"


PendCart_249987d3_data.obj : $(START_DIR)/slprj/raccel/PendCart_249987d3/PendCart_249987d3_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


PendCart_249987d3_tgtconn.obj : $(START_DIR)/slprj/raccel/PendCart_249987d3/PendCart_249987d3_tgtconn.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.obj : $(START_DIR)/slprj/raccel/PendCart_249987d3/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
